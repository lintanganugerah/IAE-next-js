...
export default function Footer() {
  return (
    <>
      <div className="my-[60px] bg-gray-900 hover:pt-0">
        <footer className="mt-5 max-w-screen-2xl px-4 mx-auto md:px-8">
          ...
          <p className="text-gray-400 text-sm text-center border-t border-gray-800 py-8">
            © 2023 - Nexto Apparel. All rights reserved.
          </p>
        </footer>
      </div>
    </>
